(async () => {
  ...
  const injectTypography = () => {
    ...
    style.textContent = `
      ...
      .site-header nav{grid-column:2!important;align-self:end!important;justify-self:center!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:clamp(1.2rem,3.2vw,3.6rem)!important;min-width:0!important;margin-bottom:clamp(.08rem,.22vw,.22rem)!important}
      ...
      .site-header .language-switch{grid-column:3!important;align-self:start!important;justify-self:end!important;display:flex;gap:.42rem;align-items:center;margin:0!important}
      ...
      .hero.is-static .hero-slide img{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;object-fit:cover!important;object-position:center 64%;filter:saturate(.88) contrast(1.05) brightness(.82);transform:scale(1.01)!important}
